odoo.define('geedy_accounting.general_ledger', function (require) {
    'use strict';
    ...
    var QWeb = core.qweb;
    var _t = core._t;
    var trial = require('geedy_accounting.trial_balance');
        ...
        load_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'report_name': 'geedy_accounting.general_ledger',
                    'report_file': 'geedy_accounting.general_ledger',
                    'data': {
                        'report_data': data
                    },
                    'context': {
