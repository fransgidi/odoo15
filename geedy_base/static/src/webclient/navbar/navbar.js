...
import { AppsMenu } from "@geedy_base/webclient/appsmenu/appsmenu";
import { AppsBar } from "@geedy_base/webclient/appsbar/appsbar";
import { SwitchCompanyMenu } from "@web/webclient/switch_company_menu/switch_company_menu";
import { UserMenu } from "@web/webclient/user_menu/user_menu";

patch(NavBar.prototype, "geedy_base.NavBar", {
    setup() {
        this._super();
...
patch(NavBar, "geedy_base.NavBar", {
    components: {
        ...NavBar.components,
        AppsMenu,
        AppsBar,
